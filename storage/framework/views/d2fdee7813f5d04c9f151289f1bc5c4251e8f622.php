...
<head>
    ...
    <style>
        ...
        .btn-action {
            ...
            width: 100px; /* Add this line to make buttons the same width */
            ...
            <tr>
                ...
                <td>
                    <div class="btn-container">
                        <form action="/livro/<?php echo e($livro->id); ?>" method="post" style="display: inline-block;">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
                            <button type="submit" class="btn-action"><ion-icon name="trash-outline"></ion-icon> Deletar</button>
                        </form>
                        <a href="/livro/editar/<?php echo e($livro->id); ?>" class="btn-action edit-btn">Editar</a>
                    </div>
                </td>
            </tr>
...
<?php /**PATH C:\laravel\Livraria\resources\views/dashbord.blade.php ENDPATH**/ ?>