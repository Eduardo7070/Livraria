      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="right-content">
            <div class="row">
              <div class="col-lg-9">
                <form action="<?php echo e(route('livro.store')); ?>" method="post" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
                  <div class="row">
                    <div class="col-lg-6">
                      <fieldset>
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="col-lg-3 d-flex flex-column align-items-end">
                <a href="<?php echo e(url('/dashbord')); ?>" class="btn btn-danger w-100">Deletar/Editar</a>
              </div>
...
<?php /**PATH C:\laravel\Livraria\resources\views/admin.blade.php ENDPATH**/ ?>