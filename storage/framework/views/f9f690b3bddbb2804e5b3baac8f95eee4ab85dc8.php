      ...
      <div class="row">
        ...
        <div class="col-lg-4 offset-lg-2">
          <div class="right-image">
            <img src="<?php echo e(asset('images/capa1.png')); ?>" alt="" style="height: 500px;" >
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="item">
            <div class="thumb">
                ...
                <a href="product-details.html"><img src="<?php echo e(asset('images/capa1.png')); ?>" alt="" class="outros"></a>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="item">
            <div class="thumb">
              <a href="product-details.html"><img src="<?php echo e(asset('images/capa2.png')); ?>" alt="" class="outros"></a>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="item">
            <div class="thumb">
              <a href="product-details.html"><img src="<?php echo e(asset('images/capa3.png')); ?>" alt="" class="outros"></a>
              <span class="price">R$44</span>
            </div>
            <div class="down-content">
              <span class="category">Robson</span>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="item">
            <div class="thumb">
              <a href="product-details.html"><img src="<?php echo e(asset('images/capa4.png')); ?>" alt="" class="outros"></a>
...
<?php /**PATH C:\laravel\Livraria\resources\views/welcome.blade.php ENDPATH**/ ?>