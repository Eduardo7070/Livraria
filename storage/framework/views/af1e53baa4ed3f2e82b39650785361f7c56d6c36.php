            ...
            <div class="col-12">
                ...
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                      ...
                      <li><a href="<?php echo e(url('/contato')); ?>" class="active">Contato</a></li>
              ...
              <div class="col-lg-12">
                <form id="contact-form" action="" method="post">
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <fieldset>
                        <input type="surname" name="surname" id="surname" placeholder="Seu Sobrenome..." autocomplete="on" required>
                      </fieldset>
                    </div>
                    <div class="col-lg-6">
                      <fieldset>
                    ...
                    <div class="col-lg-12">
                      <fieldset>
                        <textarea name="message" id="message" placeholder="Sua Messagem"></textarea>
                      </fieldset>
                    </div>
                    <div class="col-lg-12">
                      <fieldset>
...
</html><?php /**PATH C:\laravel\Livraria\resources\views/contato.blade.php ENDPATH**/ ?>